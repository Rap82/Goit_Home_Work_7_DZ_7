...
def decode ( data ) : # Функція приймає закодований за вказаним алгоритмом список (алгоритм схожий на архівуваня ) і повертає розкодований список значень .
    ...
    decoded_list = []  # Списко в який будемо додавати всі значення повернуті з функції рекурсивно аж поки не сформуємо остаточний список який і повернем з основної функцї.
